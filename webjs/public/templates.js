...
window.UNIFIED_TEMPLATES = {
  tiktok_viral: {
    ...
    desc: '9:16, subtitle bounce, hook glitch, thumbnail auto',
    cfg: {
      aspect_ratio: '9:16',
      portrait_mode: 'crop',
      ...
      hook: true,
      gpu: true,
      hook_style: { box_mode: 'fit_text', font_color: '#ffffff', bg_color: '#000000', corner_radius: 12, font_size: 0.08, bg_opacity: 100, glitch: true },
      smooth_follow: false,
  ...
  gaming_action: {
    label: '🎮 Gaming / Action',
    desc: 'Subtitle bounce, warna cool, motion blur, thumbnail auto',
    cfg: {
      aspect_ratio: '9:16',
      portrait_mode: 'crop',
      subtitle_style: 'bounce',
  ...
  education_clean: {
    ...
    cfg: {
      ...
      hook: true,
      gpu: true,
      hook_style: { box_mode: 'fit_text', font_color: '#ffffff', bg_color: '#fe2c55', corner_radius: 8, font_size: 0.075, bg_opacity: 100, glitch: false },
      smooth_follow: false,
      face_tracking_mode: 'mediapipe',
      face_detector_model: 'mediapipe',
      yolo_size: '8n',
  ...
  news_formal: {
    ...
    cfg: {
      ...
      hook: false,
      gpu: true,
      hook_style: { box_mode: 'fit_text', font_color: '#ffffff', bg_color: '#000000', corner_radius: 8, font_size: 0.075, bg_opacity: 100, glitch: false },
      smooth_follow: false,
      face_tracking_mode: 'mediapipe',
      face_detector_model: 'mediapipe',
      yolo_size: '8n',
  ...
  vlog_dynamic: {
    label: '📹 Vlog Dinamis',
    desc: 'Follow kamera halus, subtitle bounce, thumbnail auto',
    cfg: {
      aspect_ratio: '9:16',
      portrait_mode: 'crop',
      subtitle_style: 'bounce',
      ...
      hook: true,
      gpu: true,
      hook_style: { box_mode: 'fit_text', font_color: '#ffffff', bg_color: '#000000', corner_radius: 12, font_size: 0.075, bg_opacity: 100, glitch: false },
      smooth_follow: false,
      face_tracking_mode: 'mediapipe',
      face_detector_model: 'mediapipe',
      yolo_size: '8n',
  ...
  reels_34: {
    ...
    cfg: {
      ...
      hook: true,
      gpu: true,
      hook_style: { box_mode: 'fit_text', font_color: '#ffffff', bg_color: '#0064e0', corner_radius: 10, font_size: 0.08, bg_opacity: 100, glitch: false },
      smooth_follow: false,
      face_tracking_mode: 'mediapipe',
      face_detector_model: 'mediapipe',
      yolo_size: '8n',
  ...
  story_time: {
    ...
    cfg: {
      ...
      hook: true,
      gpu: true,
      hook_style: { box_mode: 'fit_text', font_color: '#ffffff', bg_color: '#7c3aed', corner_radius: 12, font_size: 0.08, bg_opacity: 100, glitch: false },
      smooth_follow: false,
      face_tracking_mode: 'mediapipe',
      face_detector_model: 'mediapipe',
      yolo_size: '8n',
