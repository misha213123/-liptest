    ...
    timeout=float(os.environ.get('AI_HIGHLIGHT_TIMEOUT', '600.0'))
        ...
        def process_selected_highlights(self, url: str, selected_highlights: list, 
            ...
            try:
                ...
                # YouTube: download ALL selected time ranges in one yt-dlp process.
                # This dramatically reduces repeated YouTube extraction requests and
                # avoids the anti-bot challenge that appeared after ~5 clips on RunPod.
                if is_youtube:
                ...
                for i, highlight in enumerate(selected_highlights, 1):
                    ...
                    try:
                        if is_youtube and batch_section_paths:
                            # The section was already downloaded by the single batch
                            # yt-dlp process above. Copy it into this clip folder.
